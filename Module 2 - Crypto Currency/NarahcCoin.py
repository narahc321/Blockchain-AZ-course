...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 20 11:50:11 2021
    ...
    def replace_chain(self):
        ...
        for node in network_nodes:
            ...
            if response.status_code == 200:
                ...
                if length > maximum_length and self.is_chain_valid(chain):
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Narahc', amount = 1)
...
def add_transaction():
    ...
    index = blockchain.add_transaction(sender = json[transaction_keys[0]], receiver = json[transaction_keys[1]], amount = json[transaction_keys[2]])
    response = {'message': f'Transaction added in Block {index}'}
    return jsonify(response), 201
...
def connect_node():
    ...
    response = {'message': 'All the Nodes are now connected and the Blockchain contains the following nodes',
